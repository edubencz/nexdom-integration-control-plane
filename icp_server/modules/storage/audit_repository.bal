...
public const string AUDIT_MI_DEPLOYMENT_CREATE = "MI_DEPLOYMENT_CREATE";
public const string AUDIT_MI_DEPLOYMENT_PREFLIGHT = "MI_DEPLOYMENT_PREFLIGHT";
public const string AUDIT_MI_DEPLOYMENT_EXECUTE = "MI_DEPLOYMENT_EXECUTE";
public const string AUDIT_MI_DEPLOYMENT_CANCEL = "MI_DEPLOYMENT_CANCEL";
public const string AUDIT_MI_DEPLOYMENT_RETRY = "MI_DEPLOYMENT_RETRY";
...
public const string AUDIT_RESOURCE_MI_DEPLOYMENT = "MI_DEPLOYMENT";
